...
Egy alternatív nyílt forráskódú (open source) launcher a SeeRPG szerverhez.
A launcher teljes egészében saját fejlesztésű implementáció, Go nyelven, a Wails framework felhasználásával készült.
